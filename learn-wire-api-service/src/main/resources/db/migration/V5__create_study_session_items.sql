...
ADD CONSTRAINT fk_study_session_items_session
...
ALTER TABLE study_session_items
ADD CONSTRAINT uq_study_session_items_session_item_order
UNIQUE (session_id, item_order);

CREATE INDEX idx_study_session_items_session_id ON study_session_items (session_id);
