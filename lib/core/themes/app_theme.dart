...
class AppTheme {
  ...
  static DividerThemeData _buildDividerTheme(ColorScheme colorScheme) {
    return DividerThemeData(
      ...
      thickness: ThemeDimensions.size1,
      space: ThemeDimensions.spacingXs,
    );
  }
  ...
  static AppBarTheme _buildAppBarTheme(ColorScheme colorScheme) {
    return AppBarTheme(
      ...
      toolbarHeight: ThemeDimensions.size72,
    );
  }
    ...
    return FilledButtonThemeData(
      style: ButtonStyle(
        ...
        foregroundColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.disabled)) {
            return colorScheme.onSurface.withValues(
              alpha: ThemeOpacities.disabled38,
            );
          }
  ...
  static InputDecorationTheme _buildInputDecorationTheme(
    ...
    return InputDecorationTheme(
      ...
      disabledBorder: base.copyWith(
        borderSide: BorderSide(
          color: colorScheme.outline.withValues(alpha: ThemeOpacities.muted55),
        ),
      ),
    );
  }
